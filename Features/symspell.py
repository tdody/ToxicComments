...
class SymSpell:
    ...
    def create_dictionary_entry(self, w):
        ...
        >>> ss.create_dictionary_entry("abcde")
        >>> ss.dictionary
            {'abcde': ([], 1),
            'bcde': (['abcde'], 0),
            'acde': (['abcde'], 0),
    ...
    def create_dictionary_from_arr(self, arr, token_pattern=r'[a-z]+'):
        ...
        for line in tqdm(arr, desc="Line"):
    ...
    def get_suggestions(self, string, silent=False):
        ...
        while len(queue) > 0:
            ...
            # early exit (stop when first valid suggestion is found)
